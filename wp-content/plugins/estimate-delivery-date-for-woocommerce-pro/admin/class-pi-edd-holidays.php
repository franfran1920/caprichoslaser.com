...
class Class_Pi_Edd_Holidays{
    ...
    private $this_tab = 'shipping_holidays';

    private $tab_name = "Shipping holidays";
    ...
    function __construct($plugin_name){
        ...
        $this->settings = array(
            array('field'=>'title', 'class'=> 'bg-primary text-light', 'class_title'=>'text-light font-weight-light h4', 'label'=>__("Select shipping holidays",'pi-edd'), 'type'=>"setting_category"),
    ...
    function tab(){
        ...
        <span class="dashicons dashicons-no"></span> <?php _e( $this->tab_name, 'pisol-edd' ); ?> 
        </a>
        <?php
    }
       ...
       ?>
        ...
        <div class="row">
            <div class="col-12 col-md-7">
                ...
                <input type="button" id="reset-holidays" class="mt-3 btn btn-primary btn-md bg-primary" value="Delete all dates" />
            </div>
            <div class="col-12 col-md-5">
                <h3><?php _e('Selected holiday dates','pi-edd'); ?></h3>
                <div id="pi-selected-holidays">
                <?php
                    if(!empty($dates)){
